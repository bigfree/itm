...
export class AuthorizeResolver {
     ...
     *
     * @param {AccessTokenData} jwtTokenData - The decoded JWT token data of the user.
    ...
    @Mutation(() => User)
    public async logout(@CurrentUser() jwtTokenData: AccessTokenData): Promise<User | null> {
